 ...
 */
PID::PID(float init_state, float kp, float ki, float kd)
{
    // PID values
    this->integrator = 0.0;
    this->error = 0.0;
...
/**
 * @brief Copy and assign a PID into another one
 *
 * @param pid a PID controller to copy and assign
 */
void PID::operator=(const PID& pid)
{
    // PID values
 ...
 * @param init_state starting state of the system
 */
void PID::begin(float init_state)
{
    // PID values
    this->integrator = 0.0;
    this->error = 0.0;
 ...
 * @param kd derivative coefficient
 */
void PID::begin(float init_state, float kp, float ki, float kd)
{
    // PID values
    this->integrator = 0.0;
    this->error = 0.0;
 ...
 * @param is_bounded
 */
void PID::setBounded(bool is_bounded)
{
 ...
 */
void PID::setOutputRange(float lower, float upper)
{
    this->low = lower;
    this->high = upper;
}
 ...
 */
void PID::setTolerance(float setpoint_tol, float derivative_tol, bool apply_tolerance)
{
 ...
 */
void PID::setIntegratorBounds(float min, float max)
{
 ...
 */
float PID::update(float target_state, float cur_state)
{
    ...
    this->integrator += 0.5 * ((this->kI * this->error) + this->prev_error) * this->dt;
